...
class CategorieController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $categories = $em->getRepository('MainBundle:Categorie')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('MainBundle\Form\CategorieType', $cat);
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('categorie_show', array('id' => $cat->getId()));
        }
    ...
    {
        $deleteForm = $this->createDeleteForm($categorie);
        $editForm = $this->createForm('MainBundle\Form\CategorieType', $categorie);
