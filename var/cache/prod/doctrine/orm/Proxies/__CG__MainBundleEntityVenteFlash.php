...
class VenteFlash extends \MainBundle\Entity\VenteFlash implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'MainBundle\\Entity\\VenteFlash' . "\0" . 'id', '' . "\0" . 'MainBundle\\Entity\\VenteFlash' . "\0" . 'theme', '' . "\0" . 'MainBundle\\Entity\\VenteFlash' . "\0" . 'image', '' . "\0" . 'MainBundle\\Entity\\VenteFlash' . "\0" . 'description', '' . "\0" . 'MainBundle\\Entity\\VenteFlash' . "\0" . 'nom', '' . "\0" . 'MainBundle\\Entity\\VenteFlash' . "\0" . 'vendeur', 'produit', '' . "\0" . 'MainBundle\\Entity\\VenteFlash' . "\0" . 'datedebut', '' . "\0" . 'MainBundle\\Entity\\VenteFlash' . "\0" . 'finish'];
        }
