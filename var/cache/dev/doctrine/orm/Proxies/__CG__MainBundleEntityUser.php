 ...
 */
class User extends \MainBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'pays', 'ville', 'cp', 'statutcoupon', 'sexe', 'firstname', 'lastname', 'produit', 'venteflash', 'magasin', 'datenaissance', 'nom', '' . "\0" . 'MainBundle\\Entity\\User' . "\0" . 'imageFile', '' . "\0" . 'MainBundle\\Entity\\User' . "\0" . 'imageName', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'roles'];
        }
    ...
    public function addVenteflash(\MainBundle\Entity\VenteFlash $venteflash)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addVenteflash', [$venteflash]);

        return parent::addVenteflash($venteflash);
    }
    ...
    public function removeVenteflash(\MainBundle\Entity\VenteFlash $venteflash)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeVenteflash', [$venteflash]);

        return parent::removeVenteflash($venteflash);
    }
    ...
    public function setStatutcoupon($statutcoupon)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setStatutcoupon', [$statutcoupon]);

        return parent::setStatutcoupon($statutcoupon);
    }
    ...
    public function getStatutcoupon()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getStatutcoupon', []);

        return parent::getStatutcoupon();
    }
    ...
    public function addMagasin(\MainBundle\Entity\Magasin $magasin)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addMagasin', [$magasin]);

        return parent::addMagasin($magasin);
    }
    ...
    public function removeMagasin(\MainBundle\Entity\Magasin $magasin)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeMagasin', [$magasin]);

        return parent::removeMagasin($magasin);
    }
